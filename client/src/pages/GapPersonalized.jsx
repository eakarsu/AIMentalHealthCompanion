...
// Personalized
// Personalized CBT/DBT delivery with automated homework tracking
...
export default function GapPersonalized() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Personalized CBT/DBT delivery with automated homework tracking</p>
