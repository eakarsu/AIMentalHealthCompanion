...
// Family
// Family / support network active involvement workflows

export default function GapFamily() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-family', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Family</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Family / support network active involvement workflows</p>
