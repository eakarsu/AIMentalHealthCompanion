...
// Streaming
// Streaming mood anomaly detection across journal/mood/chat signals
...
export default function GapStreaming() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Streaming mood anomaly detection across journal/mood/chat signals</p>
