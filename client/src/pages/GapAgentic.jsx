...
// Agentic
// Agentic 24/7 companion with crisis de-escalation and seamless therapist escalation
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic 24/7 companion with crisis de-escalation and seamless therapist escalation</p>
