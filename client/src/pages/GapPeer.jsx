...
// Peer
// Peer support orchestration with agentic group facilitation

export default function GapPeer() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-peer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Peer</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Peer support orchestration with agentic group facilitation</p>
