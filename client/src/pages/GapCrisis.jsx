...
// Crisis
// Crisis SMS text line integration

export default function GapCrisis() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-crisis', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Crisis</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Crisis SMS text line integration</p>
