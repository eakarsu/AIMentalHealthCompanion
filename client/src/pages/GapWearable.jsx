...
// Wearable
// Wearable device sync (Apple Health, Fitbit, Whoop) beyond generic integrations

export default function GapWearable() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-wearable', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Wearable</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Wearable device sync (Apple Health, Fitbit, Whoop) beyond generic integrations</p>
